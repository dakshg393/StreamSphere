...
const HorizontalCard = ({ isSmall = 0, thumbnail = "", title = "", owner = "", views = "", createdAt = "", isPlaylist = false, id }) => {


    return (
        <Link to={`/video/${id}`} className={`bg-white  p-2.5  w-[90%] ${isSmall ? "h-28" : "h-50"} flex flex-row   rounded-sm shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200`}>
